...
export function getPersonSchema() {
  return {
    ...
    homeLocation: {
      "@type": "Place",
      name: `${siteConfig.location.city}, ${siteConfig.location.region}, Australia`,
      address: {
        "@type": "PostalAddress",
    ...
    affiliation: [
      {
        "@type": "Organization",
        name: "Sunswift Racing",
        sameAs: "https://www.sunswift.com/",
      },
      {
        "@type": "Organization",
        name: "Commonwealth Bank of Australia",
        sameAs: "https://www.commbank.com.au",
      },
      {
        "@type": "Organization",
        name: "InfoTrack",
        sameAs: "https://www.infotrack.com.au",
      },
    ],
    alumniOf: {
